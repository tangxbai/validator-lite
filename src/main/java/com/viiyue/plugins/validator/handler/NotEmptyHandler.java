...
import com.viiyue.plugins.validator.constraints.NotEmpty;
import com.viiyue.plugins.validator.metadata.Fragment;
import com.viiyue.plugins.validator.scripting.Context;

/**
 * Validates the annotated objects cannot be empty and cannot be whitespace
 * characters, but can be spaces.
 * 
 * @author tangxbai
 * @since 1.0.0
 * 
 * @see NotEmpty
 */
public final class NotEmptyHandler extends BaseHandler {
	
	public NotEmptyHandler() {
		super( "not-empty" );
	}
