...
import com.viiyue.plugins.validator.constraints.EndsWith.EndsWithProvider;
import com.viiyue.plugins.validator.metadata.Fragment;
import com.viiyue.plugins.validator.provider.AnnotationProvider;

/**
 * Validates the annotated string should end with any element in the specified element array.
 *
 * @author tangxbai
 * @since 1.0.0
 */
...
@Retention( RUNTIME )
@Documented
@Mapping( name = "suffixs", usage = "suffixs(?, ?, ...)", provider = EndsWithProvider.class )
public @interface EndsWith {
	...
	class EndsWithProvider implements AnnotationProvider<EndsWith> {
		@Override
		public Fragment create( EndsWith defined, String defaultName ) {
