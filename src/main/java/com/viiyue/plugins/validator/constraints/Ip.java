...
/**
 * Validates the annotated string must be a valid IPV4 address.
 * 
 * <p>Regular expression: "^(25[0-5]|2[0-4]\d|[0-1]\d{2}|[1-9]?\d)\.(25[0-5]|2[0-4]\d|[0-1]\d{2}|[1-9]?\d)\.(25[0-5]|2[0-4]\d|[0-1]\d{2}|[1-9]?\d)\.(25[0-5]|2[0-4]\d|[0-1]\d{2}|[1-9]?\d)$"</p>
 * 
 * @author tangxbai
 * @since 1.0.0
 */
