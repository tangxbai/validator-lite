...
import com.viiyue.plugins.validator.constraints.Equals.EqualsProvider;
...
@Retention( RUNTIME )
@Documented
@Mapping( usage = "equals(?) | equals('#property')", provider = EqualsProvider.class )
public @interface Equals {
	...
	class EqualsProvider implements AnnotationProvider<Equals> {
		@Override
		public Fragment create( Equals defined, String defaultName ) {
			return Fragment.of( defaultName )
				.groups( defined.groups() )
				.message( defined.message() )
				.arguments( defined.target() );
		}
	}
