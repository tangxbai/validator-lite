...
import com.viiyue.plugins.validator.constraints.Min.MinProvider;
...
@Retention( RUNTIME )
@Documented
@Mapping( usage = "min(?)", provider = MinProvider.class )
public @interface Min {
	...
	class MinProvider implements AnnotationProvider<Min> {
		@Override
		public Fragment create( Min defined, String defaultName ) {
