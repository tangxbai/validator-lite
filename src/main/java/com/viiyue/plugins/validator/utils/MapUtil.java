...
public class MapUtil {
	...
	/**
	 * Quickly create a map object with the given key/value
	 * 
	 * @param <K> the key type
	 * @param <V> the value type
	 * @param key the map key
	 * @param value the map value
	 * @return a new {@code HashMap<K, V>}
	 */
	public static <K, V> Map<K, V> newMap( K key, V value ) {
		final Map<K, V> newMap = new HashMap<K, V>( 1 );
	 ...
	 * @param <K> the key type
	 * @param key the map key
	 * @param value the object map value
	 * @return a new {@code HashMap<K, Object>}
	 */
	public static <K> Map<K, Object> newObjectMap( K key, Object value ) {
